...
from pbsg_document_faqs import PBSG_DOCUMENT_FAQS, document_faq_match
...
PBSG_GENERAL_ENQUIRY_FAQS = PBSG_DOCUMENT_FAQS
PBSG_GENERAL_ENQUIRY_INTENT_PATTERN = re.compile(r".*", flags=re.IGNORECASE)
...
class ChatReadRetrieveReadApproach(Approach):
    ...
    def general_enquiry_match(self, latest_content: str) -> tuple[str, dict[str, Any]] | None:
        if not PBSG_GENERAL_ENQUIRY_INTENT_PATTERN.search(latest_content):
            return None
        return document_faq_match(latest_content)
